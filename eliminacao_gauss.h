...
void imprime_sistemaV2(intervalo *matriz, intervalo *vetorB, int tamanho);
...
retorna a linha que contém o valor máximo */
uint encontraMaxV2(intervalo *matriz, uint i, uint tamanho);
...
void trocaLinhasV2(intervalo *matriz, intervalo *vetorB, int i, int iPivo);
...
void retrossubsV2(intervalo *matriz, intervalo *vetorB, intervalo *vetorX, int tamanho);
...
void eliminacaoGaussV2(intervalo *matriz, intervalo *vetorB, int tamanho);